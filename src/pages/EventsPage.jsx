      ...
      <section className="section section-alt">
        <div className="container">
          <div className="events-grid">
            ...
            <div className="event-card"><div className="event-date-bar"><div><div className="event-day">18</div><div className="event-month">Dec</div></div><span>Academic</span></div><div className="event-info"><div className="event-title">Science Fair 2026</div><div className="event-desc">Student project presentations</div></div></div>
            <div className="event-card"><div className="event-date-bar"><div><div className="event-day">22</div><div className="event-month">Dec</div></div><span>Holiday</span></div><div className="event-info"><div className="event-title">Winter Break Begins</div><div className="event-desc">School resumes January 6, 2027</div></div></div>
