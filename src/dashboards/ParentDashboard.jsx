        ...
        <div className="dashboard-content">
            ...
            <div className="cards-grid">
              ...
              <div className="card"><div className="card-title mb-2">📝 Pending Homework</div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  <div style={{ padding: '0.6rem', background: 'var(--bg)', borderRadius: '6px', borderLeft: '3px solid var(--danger)' }}><div style={{ fontWeight: 600, fontSize: '0.85rem' }}>Math — Exercise 5.3</div><div className="text-muted text-sm">Due: Dec 5, 2024</div></div>
                  <div style={{ padding: '0.6rem', background: 'var(--bg)', borderRadius: '6px', borderLeft: '3px solid var(--warning)' }}><div style={{ fontWeight: 600, fontSize: '0.85rem' }}>Physics — Lab Report</div><div className="text-muted text-sm">Due: Dec 8, 2024</div></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="dash-section" id="par-attendance">
            ...
            <div className="card" style={{ maxWidth: '600px' }}>
              ...
              <div className="progress-bar-wrap"><div className="progress-label"><span>Nov 2024</span><span style={{ fontWeight: 700 }}>96%</span></div><div className="progress-track"><div className="progress-fill" style={{ width: '96%' }}></div></div></div>
              <div className="progress-bar-wrap"><div className="progress-label"><span>Oct 2024</span><span style={{ fontWeight: 700 }}>92%</span></div><div className="progress-track"><div className="progress-fill" style={{ width: '92%' }}></div></div></div>
              <div className="progress-bar-wrap"><div className="progress-label"><span>Sep 2024</span><span style={{ fontWeight: 700 }}>95%</span></div><div className="progress-track"><div className="progress-fill" style={{ width: '95%' }}></div></div></div>
            </div>
          </div>
          ...
          <div className="dash-section" id="par-homework">
            ...
            <div className="announcements-list">
              <div className="announcement-item"><span className="ann-badge badge-notice">PENDING</span><div className="ann-content"><div className="ann-title">Mathematics — Exercise 5.3 (Quadratic Equations)</div><div className="ann-meta">Assigned by Mr. Kumar · Due Dec 5, 2024</div></div></div>
              <div className="announcement-item"><span className="ann-badge badge-notice">PENDING</span><div className="ann-content"><div className="ann-title">Physics — Lab Report: Reflection of Light</div><div className="ann-meta">Assigned by Ms. Priya · Due Dec 8, 2024</div></div></div>
              <div className="announcement-item"><span className="ann-badge badge-new">SUBMITTED</span><div className="ann-content"><div className="ann-title">English — Essay: My Favourite Book</div><div className="ann-meta">Assigned by Mrs. Rao · Submitted Nov 30, 2024</div></div></div>
            </div>
          </div>
          ...
          <div className="dash-section" id="par-feedback">
            ...
            <div className="announcements-list">
              <div className="announcement-item"><span className="ann-badge" style={{ background: '#dbeafe', color: '#1d4ed8' }}>Ms. Priya</span><div className="ann-content"><div className="ann-title">Arjun shows great aptitude in Physics. Encourage him to practice numerical problems daily for board prep.</div><div className="ann-meta">Physics Teacher · Nov 28, 2024</div></div></div>
              <div className="announcement-item"><span className="ann-badge" style={{ background: '#dcfce7', color: '#15803d' }}>Mr. Kumar</span><div className="ann-content"><div className="ann-title">Mathematics performance is excellent. Arjun consistently ranks in the top 3 of class.</div><div className="ann-meta">Mathematics Teacher · Nov 25, 2024</div></div></div>
              <div className="announcement-item"><span className="ann-badge" style={{ background: '#fef3c7', color: '#b45309' }}>Mrs. Rao</span><div className="ann-content"><div className="ann-title">English composition could be improved. Encourage daily reading and writing practice at home.</div><div className="ann-meta">English Teacher · Nov 22, 2024</div></div></div>
            </div>
          </div>
          ...
          <div className="dash-section" id="par-announcements">
            ...
            <div className="announcements-list">
              <div className="announcement-item"><span className="ann-badge badge-new">NEW</span><div className="ann-content"><div className="ann-title">Parent-Teacher Meeting — December 14, 2024</div><div className="ann-meta">Principal's Office · Dec 2, 2024</div></div></div>
              <div className="announcement-item"><span className="ann-badge badge-notice">NOTICE</span><div className="ann-content"><div className="ann-title">Fee Payment Deadline — December 15, 2024</div><div className="ann-meta">Accounts Office · Nov 30, 2024</div></div></div>
            </div>
          </div>
