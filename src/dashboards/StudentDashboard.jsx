  ...
  return (
    <div className="dashboard-page" id="page-student-dashboard">
      <aside className="sidebar">
        ...
        <div className="sidebar-user"><div className="sidebar-avatar">👨‍🎓</div><div className="sidebar-user-name">Arjun Sharma</div><div className="sidebar-user-role">Class 10A · Roll No. VID2024042</div></div>
        ...
        <div className="dashboard-content">
          ...
          <div className="dash-section active" id="std-home">
            ...
            <div className="cards-grid">
              ...
              <div className="card"><div className="card-header"><div className="card-title">📣 Latest Notice</div></div><div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}><div style={{ padding: '0.7rem', background: 'var(--bg)', borderRadius: '8px', borderLeft: '3px solid var(--accent)' }}><div style={{ fontWeight: 600, fontSize: '0.85rem' }}>Pre-Board Exam Schedule Released</div><div className="text-muted text-sm">Dec 2, 2024</div></div><div style={{ padding: '0.7rem', background: 'var(--bg)', borderRadius: '8px', borderLeft: '3px solid var(--secondary)' }}><div style={{ fontWeight: 600, fontSize: '0.85rem' }}>Science Fair Registration Open</div><div className="text-muted text-sm">Nov 30, 2024</div></div></div></div>
            </div>
          </div>
          ...
          <div className="dash-section" id="std-materials">
            ...
            <div className="materials-list">
              <div className="material-item"><span className="material-icon">📘</span><div className="material-info"><div className="material-name">Mathematics — Chapter 5: Quadratic Equations</div><div className="material-meta">PDF · 2.4 MB · Uploaded Nov 28, 2024</div></div><span className="material-action">Download ↓</span></div>
              <div className="material-item"><span className="material-icon">📗</span><div className="material-info"><div className="material-name">Physics — Wave Optics Notes</div><div className="material-meta">PDF · 3.1 MB · Uploaded Nov 25, 2024</div></div><span className="material-action">Download ↓</span></div>
              <div className="material-item"><span className="material-icon">📙</span><div className="material-info"><div className="material-name">Chemistry — Organic Reactions Summary</div><div className="material-meta">PDF · 1.8 MB · Uploaded Nov 22, 2024</div></div><span className="material-action">Download ↓</span></div>
              <div className="material-item"><span className="material-icon">📕</span><div className="material-info"><div className="material-name">English — Prose &amp; Poetry Analysis</div><div className="material-meta">PDF · 1.2 MB · Uploaded Nov 20, 2024</div></div><span className="material-action">Download ↓</span></div>
              <div className="material-item"><span className="material-icon">📓</span><div className="material-info"><div className="material-name">Social Studies — History Chapter 8 Notes</div><div className="material-meta">PDF · 2.0 MB · Uploaded Nov 18, 2024</div></div><span className="material-action">Download ↓</span></div>
              <div className="material-item"><span className="material-icon">📒</span><div className="material-info"><div className="material-name">Telugu — Grammar and Composition Guide</div><div className="material-meta">PDF · 1.5 MB · Uploaded Nov 15, 2024</div></div><span className="material-action">Download ↓</span></div>
              <div className="material-item"><span className="material-icon">📔</span><div className="material-info"><div className="material-name">Hindi — Literature Study Guide</div><div className="material-meta">PDF · 1.3 MB · Uploaded Nov 12, 2024</div></div><span className="material-action">Download ↓</span></div>
            </div>
          </div>
          ...
          <div className="dash-section" id="std-announcements">
            ...
            <div className="announcements-list">
              <div className="announcement-item"><span className="ann-badge badge-new">NEW</span><div className="ann-content"><div className="ann-title">Pre-Board Examination Schedule — December 2024</div><div className="ann-meta">Posted by Academic Office · Dec 2, 2024</div></div></div>
              <div className="announcement-item"><span className="ann-badge badge-event">EVENT</span><div className="ann-content"><div className="ann-title">Annual Science Fair — Project Submission by Dec 10</div><div className="ann-meta">Posted by Science Dept. · Nov 30, 2024</div></div></div>
              <div className="announcement-item"><span className="ann-badge badge-notice">NOTICE</span><div className="ann-content"><div className="ann-title">Library Books Return Deadline — December 12</div><div className="ann-meta">Posted by Library · Nov 28, 2024</div></div></div>
              <div className="announcement-item"><span className="ann-badge badge-event">EVENT</span><div className="ann-content"><div className="ann-title">Annual Sports Day Participation Form Available</div><div className="ann-meta">Posted by PE Dept. · Nov 25, 2024</div></div></div>
              <div className="announcement-item"><span className="ann-badge badge-notice">NOTICE</span><div className="ann-content"><div className="ann-title">Fee Payment Reminder — Last Date Dec 15</div><div className="ann-meta">Posted by Accounts · Nov 22, 2024</div></div></div>
            </div>
          </div>

          {/* Calendar */}
          <div className="dash-section" id="std-calendar">
            <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.5rem', fontWeight: 900, marginBottom: '1.5rem' }}>📅 Academic Calendar — December 2024</h2>
            <div className="card" style={{ maxWidth: '420px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}><button className="topbar-btn">‹</button><div style={{ fontWeight: 700 }}>December 2024</div><button className="topbar-btn">›</button></div>
            ...
            <div style={{ marginTop: '1.5rem' }}>
              ...
              <div className="upcoming-event-chip"><span className="event-chip-date">Dec 18</span><span className="event-chip-name">Science Fair 2024</span><span className="event-chip-badge">Academic</span></div>
